//! Official Rust Client for FDA DSCSA & EU FMD Drug Serialization API
...
impl PharmaDscsaClient {
    pub fn new(api_key: Option<String>, base_url: Option<String>) -> Self {
        let key = api_key
            ...
            .unwrap_or_default();
        let base = base_url.unwrap_or_else(|| "https://api.stanzaapi.com/pharma-dscsa".to_string());
        ...
        Self {
            ...
            tool_url: "https://stanzaapi.com/tools/pharma-dscsa",
        }
    }
